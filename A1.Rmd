...
Sample A could be an outlier based on the MDA plot, but I am still hesitant to completely remove it
so in my downstream analysis, I will compare with and without sample A.
